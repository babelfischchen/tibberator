// GraphQL query modules - these are generated by graphql_client macro in data_handling.rs
// We need to declare them here to make the generated types available
use crate::tibber::data_handling::{
    consumption, consumption_page_info, price_current, price_hourly
};

use chrono::{DateTime, FixedOffset, Local, Timelike, Utc, Duration, TimeZone};
use crossterm::style;
...
impl ConsumptionPage {
    pub fn create_from(consumption_page: &impl ConsumptionPageInfoFields) -> Option<ConsumptionPage> {
